...
if (window.location.pathname.endsWith("q1.html")) {
  function getAutoComplete(input) {
    console.log("Autocomplete value:", input);
    // Send an AJAX request to the server for autocompletion
    $.ajax({
      type: 'POST',
      url: '../autocomplete.php', // Create a new server-side script for autocompletion
      data: { input: input },
      success: function (response) {
        // Update the autocomplete suggestions on the client side
        // Assume you have a div with the ID "autocomplete-suggestions" to display suggestions
